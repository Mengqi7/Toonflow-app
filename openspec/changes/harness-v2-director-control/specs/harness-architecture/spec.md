...
### Requirement: Harness V2 必须遵循标准 Harness 工程六要素规范
...
#### Scenario: WorkflowRunner 仅执行单任务
...
### Requirement: 端到端流转必须覆盖从小说到成片的 14 个步骤
