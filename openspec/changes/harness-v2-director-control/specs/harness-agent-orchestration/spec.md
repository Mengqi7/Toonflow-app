...
### Requirement: WorkflowRunner 是单任务执行容器, 不再是顶层调度者
...
#### Scenario: DirectorOrchestrator 调用 enqueueTask
...
### Requirement: AgentRegistry 必须注册 15 个 Agent (8 旧 + 7 新 + 1 director 升级)
